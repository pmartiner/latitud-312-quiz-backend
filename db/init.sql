...
INSERT INTO preguntas_quiz(pregunta, pregunta_corta, input)
VALUES ('¿Estás a favor o en contra de la legalización de la marihuana para fines recreativos?', 'Legalización de la marihuana para fines recreativos', '{"type":"radio","values":[{"label":"A favor ✅","value":"A favor"},{"label":"Indeciso/a 🤔","value":"Indecisión"},{"label":"En contra ❌","value":"En contra"}]}');
INSERT INTO preguntas_quiz(pregunta, pregunta_corta, input)
